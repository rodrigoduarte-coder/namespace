...
| Comprimento recomendado | **5–8 caracteres no total** — namespaces maiores quebram restrições de comprimento de certos objetos de repositório | Notes 105132 e 395083 |
| Caixa | Maiúsculas | convenção SAP documentada |
...
| Caracteres permitidos | Convenção ABAP: letras A–Z e dígitos 0–9; primeira posição letra. ⚠️ O conjunto exato exigido pelo diálogo "Request Namespace" é exibido apenas no próprio app — mostre as regras do diálogo ao usuário e valide lá antes de submeter | ABAP naming conventions (regra geral); diálogo do app (fonte final) |
